...
f_cTcPnm <- if (file.exists("pages/Data/f_PNMChildTeenCheckup.csv")) {
  read.csv("pages/Data/f_PNMChildTeenCheckup.csv")  
} else {
  read.csv("./Data/f_PNMChildTeenCheckup.csv")  
}
